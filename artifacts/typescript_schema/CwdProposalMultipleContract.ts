...
export class CwdProposalMultipleQueryContract extends Contract implements CwdProposalMultipleReadOnlyInterface {
...
export class CwdProposalMultipleContract extends CwdProposalMultipleQueryContract implements CwdProposalMultipleInterface {
  constructor(instantiateTag?: string) {
    super("cwd_proposal_multiple", instantiateTag);

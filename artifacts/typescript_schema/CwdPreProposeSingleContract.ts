...
export class CwdPreProposeSingleQueryContract extends Contract implements CwdPreProposeSingleReadOnlyInterface {
...
export class CwdPreProposeSingleContract extends CwdPreProposeSingleQueryContract implements CwdPreProposeSingleInterface {
  constructor(instantiateTag?: string) {
    super("cwd_pre_propose_single", instantiateTag);

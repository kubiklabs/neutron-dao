...
export interface CwdSubdaoPreProposeSingleReadOnlyInterface {
...
export class CwdSubdaoPreProposeSingleQueryContract extends Contract implements CwdSubdaoPreProposeSingleReadOnlyInterface {
...
export interface CwdSubdaoPreProposeSingleInterface extends CwdSubdaoPreProposeSingleReadOnlyInterface {
  propose: ({
    account,
    customFees,
    memo,
...
export class CwdSubdaoPreProposeSingleContract extends CwdSubdaoPreProposeSingleQueryContract implements CwdSubdaoPreProposeSingleInterface {
  constructor(instantiateTag?: string) {
    super("cwd_subdao_pre_propose_single", instantiateTag);

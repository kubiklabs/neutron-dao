...
export interface MultipleChoiceOption {
  description: string;
  msgs?: CosmosMsg_for_NeutronMsg[] | null;
  [k: string]: unknown;
}
...
export class CwdPreProposeMultipleQueryContract extends Contract implements CwdPreProposeMultipleReadOnlyInterface {
...
export class CwdPreProposeMultipleContract extends CwdPreProposeMultipleQueryContract implements CwdPreProposeMultipleInterface {
  constructor(instantiateTag?: string) {
    super("cwd_pre_propose_multiple", instantiateTag);

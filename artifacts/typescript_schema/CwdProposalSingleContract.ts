...
export class CwdProposalSingleQueryContract extends Contract implements CwdProposalSingleReadOnlyInterface {
...
export class CwdProposalSingleContract extends CwdProposalSingleQueryContract implements CwdProposalSingleInterface {
  constructor(instantiateTag?: string) {
    super("cwd_proposal_single", instantiateTag);
